...
(function ($) {
    $.fn.responsinav = function (o) {
        var o = jQuery.extend({ breakpoint : 768 }, o);
        // 0 = Full, 1 = Mobile
        rn_mode = undefined;
        ...
        nav = {
            ...
            mobile : function() {
                ...
                if($('nav>a.mobile_handle').length==0){ $('<a class="mobile_handle">Open/Close Menu<i class="icon-reorder"></i></a>').prependTo('nav'); }
                ...
                if($('.sub_nav').length==0){
                    $('nav ul li').each(function(){
                        ...
                        $('<a class="sub_nav"><div class="arrow_down"></div></a>').prependTo(this); }
                    });
                }
                // Sub-Nav
